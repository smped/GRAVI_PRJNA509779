  ...
  mclapply(
    ...
    function(x) {
      ...
      cp <- htmltools::tags$em(
        ...
        based on {c1} only. If more than {n_max} ranges were provided, only 
        {n_max} will be plotted. Values plotted are log2 fold-enrichmenbt over 
        Input as produced by macs2 bdgcmp.
        "
        )
      )
      htmltools::div(
